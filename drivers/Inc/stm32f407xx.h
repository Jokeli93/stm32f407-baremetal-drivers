...
//Definition structure of the I2C peripheral
typedef struct
{
	__vo uint32_t CR1;
	__vo uint32_t CR2;
...
//Definition structure of the USART peripheral
typedef struct
{
	__vo uint32_t SR;
	__vo uint32_t DR;
...
//Peripheral definition of the I2C
#define I2C1 ((I2C_RegDef_t*)I2C1_BASEADDR)
#define I2C2 ((I2C_RegDef_t*)I2C2_BASEADDR)
#define I2C3 ((I2C_RegDef_t*)I2C3_BASEADDR)

//Peripheral definition of  the USART
...
//macros IRQ (Interrupt Request) number for SPI peripherals
