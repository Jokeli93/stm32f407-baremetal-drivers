 ...
 * GPIO pin pull up pull down configuration configuration macros
 */
...
void GPIO_IRQPriorityConfig(uint8_t IRQNumber, uint32_t IRQPriority); // Function to configure the IRQ priority
